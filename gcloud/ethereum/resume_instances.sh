...
do
    ...
    gcloud compute ssh $INSTANCE_NAME --zone=$ZONE --command="cd ~/poa; echo \"Echo\" ${NODE_FOLDER_INDEX} ${BOOT_NODE_IP}; ./resumeNodeByNumber.sh ${NODE_FOLDER_INDEX} ${BOOT_NODE_IP}" &
